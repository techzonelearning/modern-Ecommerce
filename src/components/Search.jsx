...
const APP_ID = "6VL1SBUQ8O";
const INDEX_NAME = "your-index-name";
const API_KEY = "bed9e293a5be7ac3abc7568a5ecfe354";
  ...
  return (
    <div className="group relative">
      <Input
        ...
        className="focus:!border-t-gray-900 group-hover:border-2 placeholder:text-gray-400 group-hover:!border-gray-900"
        labelProps={{
          className: "hidden",
        }}
        readOnly
